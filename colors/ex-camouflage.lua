...
vim.api.nvim_set_hl(0, "@variable", { fg = 14738154, link = "Variable" })
...
vim.api.nvim_set_hl(0, "LineNr", { bg = 2103833, ctermfg = 229, fg = 8292417 })
...
vim.api.nvim_set_hl(0, "Normal", { bg = 459008, ctermfg = 9, fg = 14017157 })
...
vim.api.nvim_set_hl(
  0,
  "PmenuSel",
  { bg = 9109504, blend = 0, cterm = { reverse = true, underline = true }, fg = 10145074 }
)
